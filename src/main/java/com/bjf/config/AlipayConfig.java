...
public class AlipayConfig {
    ...
    public   void setAlipay_public_key(String alipay_public_key) {
        com.bjf.config.AlipayConfig.alipay_public_key = alipay_public_key;
    }

    @Value("${return_payment_url}")
    public   void setReturn_url(String return_payment_url) {
        com.bjf.config.AlipayConfig.return_payment_url = return_payment_url;
    }

    @Value("${notify_payment_url}")
    public   void setNotify_url(String notify_payment_url) {
        com.bjf.config.AlipayConfig.notify_payment_url = notify_payment_url;
    }

    @Value("${return_order_url}")
    public   void setReturn_order_url(String return_order_url) {
        com.bjf.config.AlipayConfig.return_order_url = return_order_url;
    }
